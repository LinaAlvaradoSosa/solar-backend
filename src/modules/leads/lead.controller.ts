...
export async function createLeadHandler(request: Request, response: Response) {
  try {
...
export async function listLeadsHandler(request: Request, response: Response) {
  try {
...
export async function getLeadStatsHandler(_request: Request, response: Response) {
  try {
